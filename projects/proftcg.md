...
For this project, I mainly worked on the landing page, trade page, and the backend trade mechanics. Click on the images to view the source code!
...
For the landing page, I opted to keep a sleek, minimalistic design for the website's brand in order to allow the cards stand out on the page. Since the cards were of varying vibrant colors, I chose to keep a black and white theme that contrasted well with them. What I find to be the most fun about the landing page is that the 3 cards randomly change each time you load the page. This is done by shuffling the array of cards from the card collection, and then loading in the first 3 cards in the array.
